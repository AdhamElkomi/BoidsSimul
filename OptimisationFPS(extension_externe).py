...
match BOID_COUNT:
    ...
    case 1000:
        ...
        CELL_SIZE = 50
        FRAME_RATE = 30
        COHESION_ALIGNMENT_UPDATE_INTERVAL = 15 
        BOID_SIZE = 4
    case 500:
        ...
        CELL_SIZE = 75
        FRAME_RATE = 40
        COHESION_ALIGNMENT_UPDATE_INTERVAL = 10
        BOID_SIZE = 5
    case 250:
        ...
        CELL_SIZE = 100
        FRAME_RATE = 40
        COHESION_ALIGNMENT_UPDATE_INTERVAL = 5
        BOID_SIZE = 8
    case 100:
        ...
        CELL_SIZE = 150
        FRAME_RATE = 60
        COHESION_ALIGNMENT_UPDATE_INTERVAL = 3
        BOID_SIZE = 10
    case 50 : 
        SEPARATION_RADIUS = 60
        ALIGNMENT_RADIUS = 200
        ...
        CELL_SIZE = 150
        FRAME_RATE = 60
        COHESION_ALIGNMENT_UPDATE_INTERVAL = 2 
        BOID_SIZE = 10
...
class Boid:
    ...
    def separation(self, grid):
        ...
        for other in nearby_boids:
            if other != self and self.distance_to(other) < SEPARATION_RADIUS:
                steer_x -= (other.x - self.x)/pow(self.distance_to(other),2)
                steer_y -= (other.y - self.y)/pow(self.distance_to(other),2)
    ...
    def draw(self, screen):
        ...
        draw_triangle(screen, BLUE, self.x, self.y, angle, BOID_SIZE)
